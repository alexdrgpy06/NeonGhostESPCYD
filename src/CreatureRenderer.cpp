        ...
        for (int col = 0; col <= 24; col++) {
            ...
            if (isPixelSet) {
                ...
                if (startCol != -1) {
                    ...
                    spr->fillRect(px, py, (col - startCol) * scale, scale, color); // ⚡ Bolt: RLE optimization
                    startCol = -1;
                }
            }
        }
    ...
    for (int row = 0; row < 24; row++) {
        ...
        for (int col = 0; col <= 24; col++) {
            ...
            if (isPixelSet) {
                ...
                if (startCol != -1) {
                    spr->fillRect(x + startCol * scale, y + row * scale, (col - startCol) * scale, scale, color); // ⚡ Bolt: RLE optimization
                    startCol = -1;
                }
            }
        }
