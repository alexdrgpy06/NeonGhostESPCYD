...
void drawSingleButton(int x, int y, int w, int h, const char* label, uint16_t color, bool pressed) {
    ...
    // Centering: assuming size 1 is 6px width/char, 8px height
...
void animateButtonPress(int x, int y, int w, int h, const char* label, uint16_t color) {
    drawSingleButton(x, y, w, h, label, color, true);
    delay(50); // Visual feedback
    drawSingleButton(x, y, w, h, label, color, false);
}
...
void handleTouch(int tx, int ty) {
    ...
    if (ty >= BUTTON_Y) {
        ...
        if (tx >= 15 && tx < 85) {
            // FEED
            animateButtonPress(15, BUTTON_Y, BUTTON_W, BUTTON_H, "FEED", btnColor);
            petStats.feed(20);
            ...
            animateButtonPress(85, BUTTON_Y, BUTTON_W, BUTTON_H, "ATTACK", btnColor);
            ...
            // MENU
            animateButtonPress(155, BUTTON_Y, BUTTON_W, BUTTON_H, "MENU", btnColor);
