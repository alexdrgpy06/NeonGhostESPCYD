...
void drawButtons();
void drawSingleButton(int x, const char* label, bool active);
void drawTopBar();
void drawStatusBar();
void drawGhostArea();
void fullReset();
...
void drawSingleButton(int x, const char* label, bool active) {
    ...
    if (active) {
        tft.fillRoundRect(x, BUTTON_Y, BUTTON_W, BUTTON_H, 6, themeColor);
        tft.setTextColor(C_DARK, themeColor);
    } else {
        tft.fillRoundRect(x, BUTTON_Y, BUTTON_W, BUTTON_H, 6, C_DARK);
        tft.drawRoundRect(x, BUTTON_Y, BUTTON_W, BUTTON_H, 6, themeColor);
