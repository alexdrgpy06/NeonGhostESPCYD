...
void drawButtons();
void drawSingleButton(const char* label, int x, int y, int w, int h, uint16_t color, bool pressed);
void drawTopBar();
void drawStatusBar();
void drawGhostArea();
void fullReset();
...
void drawButtons() {
    ...
    drawSingleButton("FEED", 15, BUTTON_Y, BUTTON_W, BUTTON_H, btnColor, false);
    drawSingleButton("ATTACK", 85, BUTTON_Y, BUTTON_W, BUTTON_H, btnColor, false);
    drawSingleButton("MENU", 155, BUTTON_Y, BUTTON_W, BUTTON_H, btnColor, false);
}
...
void handleTouch(int tx, int ty) {
    ...
    if (ty >= BUTTON_Y && ty <= BUTTON_Y + BUTTON_H) {
        ...
        if (tx >= 15 && tx < 85) {
            // FEED
            drawSingleButton("FEED", 15, BUTTON_Y, BUTTON_W, BUTTON_H, btnColor, true);
            delay(100);
            drawSingleButton("FEED", 15, BUTTON_Y, BUTTON_W, BUTTON_H, btnColor, false);
            ...
            drawSingleButton("ATTACK", 85, BUTTON_Y, BUTTON_W, BUTTON_H, btnColor, true);
            delay(100);
            drawSingleButton("ATTACK", 85, BUTTON_Y, BUTTON_W, BUTTON_H, btnColor, false);
            ...
            // MENU
            drawSingleButton("MENU", 155, BUTTON_Y, BUTTON_W, BUTTON_H, btnColor, true);
            delay(100);
            drawSingleButton("MENU", 155, BUTTON_Y, BUTTON_W, BUTTON_H, btnColor, false);
