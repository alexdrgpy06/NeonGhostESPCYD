...
void handleTouch(int tx, int ty) {
    ...
    if (ty >= BUTTON_Y && ty <= BUTTON_Y + BUTTON_H) {
        if (tx >= 15 && tx < 85) {
            // FEED
            drawSingleButton(15, "FEED", petStats.getStageColor(), true);
            delay(50);
            drawSingleButton(15, "FEED", petStats.getStageColor(), false);
            ...
            drawSingleButton(85, "ATTACK", petStats.getStageColor(), true);
            delay(50);
            drawSingleButton(85, "ATTACK", petStats.getStageColor(), false);
            ...
            // MENU
            drawSingleButton(155, "MENU", petStats.getStageColor(), true);
            delay(50);
            drawSingleButton(155, "MENU", petStats.getStageColor(), false);
