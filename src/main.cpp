...
void drawButton(int x, int y, int w, int h, const char* label, uint16_t themeColor, bool pressed = false) {
    uint16_t bg = pressed ? themeColor : C_DARK;
    uint16_t fg = pressed ? C_DARK : themeColor;

    tft.fillRoundRect(x, y, w, h, 6, bg);
    tft.drawRoundRect(x, y, w, h, 6, themeColor);
...
void drawButtons() {
    ...
    drawButton(x1, BUTTON_Y, BUTTON_W, BUTTON_H, "FEED", btnColor, false);
    drawButton(x2, BUTTON_Y, BUTTON_W, BUTTON_H, "ATTACK", btnColor, false);
    drawButton(x3, BUTTON_Y, BUTTON_W, BUTTON_H, "MENU", btnColor, false);
}
...
void handleTouch(int tx, int ty) {
    ...
    if (ty >= BUTTON_Y) {
        if (tx >= 15 && tx < 85) {
            // FEED
            drawButton(15, BUTTON_Y, BUTTON_W, BUTTON_H, "FEED", petStats.getStageColor(), true);
            delay(50);
            drawButton(15, BUTTON_Y, BUTTON_W, BUTTON_H, "FEED", petStats.getStageColor(), false);
            ...
            drawButton(85, BUTTON_Y, BUTTON_W, BUTTON_H, "ATTACK", petStats.getStageColor(), true);
            delay(50);
            drawButton(85, BUTTON_Y, BUTTON_W, BUTTON_H, "ATTACK", petStats.getStageColor(), false);
            ...
            // MENU
            drawButton(155, BUTTON_Y, BUTTON_W, BUTTON_H, "MENU", petStats.getStageColor(), true);
            delay(50);
            // No need to redraw unpressed as drawMenu clears screen
