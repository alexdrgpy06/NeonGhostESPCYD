...
void drawButtons();
void drawSingleButton(int x, const char* label, bool pressed = false);
void drawTopBar();
void drawStatusBar();
void drawGhostArea();
void fullReset();
...
void drawSingleButton(int x, const char* label, bool pressed) {
    ...
    uint16_t bgColor = pressed ? btnColor : C_DARK;
    uint16_t txtColor = pressed ? C_DARK : btnColor;
    ...
    // Calculate text width (size 1 is 6px per char)
