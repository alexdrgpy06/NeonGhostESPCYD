...
void drawButtons();
void drawSingleButton(int x, int y, const char* label, uint16_t color, bool pressed);
void drawTopBar();
void drawStatusBar();
void drawGhostArea();
void fullReset();
...
void drawSingleButton(int x, int y, const char* label, uint16_t color, bool pressed) {
    tft.fillRoundRect(x, y, BUTTON_W, BUTTON_H, 6, pressed ? color : C_DARK);
    tft.drawRoundRect(x, y, BUTTON_W, BUTTON_H, 6, color);
    tft.setTextColor(pressed ? C_DARK : color, pressed ? color : C_DARK);
    tft.setTextSize(1);
    // Button text in main.cpp is centered dynamically by the drawSingleButton helper, calculating text width as strlen(label) * 6 (assuming text size 1)
    int textWidth = strlen(label) * 6;
    int cursorX = x + (BUTTON_W - textWidth) / 2;
    tft.setCursor(cursorX, y + 18);
    tft.print(label);
}
...
void drawButtons() {
    ...
    drawSingleButton(x1, BUTTON_Y, "FEED", btnColor, false);
    drawSingleButton(x2, BUTTON_Y, "ATTACK", btnColor, false);
    drawSingleButton(x3, BUTTON_Y, "MENU", btnColor, false);
}
...
void handleTouch(int tx, int ty) {
    ...
    if (ty >= BUTTON_Y) {
        ...
        if (tx >= 15 && tx < 85) {
            // FEED
            drawSingleButton(15, BUTTON_Y, "FEED", btnColor, true);
            delay(50);
            drawSingleButton(15, BUTTON_Y, "FEED", btnColor, false);
            ...
            // ATTACK
            drawSingleButton(85, BUTTON_Y, "ATTACK", btnColor, true);
            delay(50);
            drawSingleButton(85, BUTTON_Y, "ATTACK", btnColor, false);
            ...
            // MENU
            drawSingleButton(155, BUTTON_Y, "MENU", btnColor, true);
            delay(50);
            drawSingleButton(155, BUTTON_Y, "MENU", btnColor, false);
