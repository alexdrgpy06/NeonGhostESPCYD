...
void drawButtons();
void drawSingleButton(int x, int y, int w, int h, uint16_t btnColor, const char* label, bool pressed = false);
void drawTopBar();
void drawStatusBar();
void drawGhostArea();
void fullReset();
...
void drawSingleButton(int x, int y, int w, int h, uint16_t btnColor, const char* label, bool pressed) {
    uint16_t fillCol = pressed ? btnColor : C_DARK;
    uint16_t textCol = pressed ? C_BG : btnColor;
    
    tft.fillRoundRect(x, y, w, h, 6, fillCol);
    tft.drawRoundRect(x, y, w, h, 6, btnColor);
...
void drawButtons() {
    ...
    drawSingleButton(x1, BUTTON_Y, BUTTON_W, BUTTON_H, btnColor, "FEED", false);
    drawSingleButton(x2, BUTTON_Y, BUTTON_W, BUTTON_H, btnColor, "ATTACK", false);
    drawSingleButton(x3, BUTTON_Y, BUTTON_W, BUTTON_H, btnColor, "MENU", false);
}
...
void handleTouch(int tx, int ty) {
    ...
    if (ty >= BUTTON_Y) {
        ...
        if (tx >= 15 && tx < 85) {
            // FEED
            drawSingleButton(15, BUTTON_Y, BUTTON_W, BUTTON_H, btnColor, "FEED", true);
            delay(50);
            drawSingleButton(15, BUTTON_Y, BUTTON_W, BUTTON_H, btnColor, "FEED", false);
            petStats.feed(20);
            ...
            drawSingleButton(85, BUTTON_Y, BUTTON_W, BUTTON_H, btnColor, "ATTACK", true);
            delay(50);
            drawSingleButton(85, BUTTON_Y, BUTTON_W, BUTTON_H, btnColor, "ATTACK", false);
            ...
            // MENU
            drawSingleButton(155, BUTTON_Y, BUTTON_W, BUTTON_H, btnColor, "MENU", true);
            delay(50);
            drawSingleButton(155, BUTTON_Y, BUTTON_W, BUTTON_H, btnColor, "MENU", false);
