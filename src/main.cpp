...
void drawButtons();
void drawSingleButton(int x, int y, int w, int h, uint16_t color, const char* label, bool pressed = false);
void drawTopBar();
void drawStatusBar();
void drawGhostArea();
void fullReset();
...
void drawSingleButton(int x, int y, int w, int h, uint16_t color, const char* label, bool pressed) {
    if (pressed) {
