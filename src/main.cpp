...
// Helper for consistent button drawing with visual feedback
void drawButton(int x, int y, int w, int h, const char* label, uint16_t color, bool pressed = false) {
    uint16_t fillColor = pressed ? color : C_DARK;
    uint16_t outlineColor = pressed ? C_DARK : color;
    uint16_t textColor = pressed ? C_DARK : color;
    uint16_t textBg = fillColor;

    tft.fillRoundRect(x, y, w, h, 6, fillColor);
    tft.drawRoundRect(x, y, w, h, 6, outlineColor);
    
    tft.setTextColor(textColor, textBg);
    tft.setTextSize(1);
    
    // Center text (font width approx 6px)
...
void drawButtons() {
    ...
    drawButton(x1, BUTTON_Y, BUTTON_W, BUTTON_H, "FEED", btnColor);
    drawButton(x2, BUTTON_Y, BUTTON_W, BUTTON_H, "ATTACK", btnColor);
    drawButton(x3, BUTTON_Y, BUTTON_W, BUTTON_H, "MENU", btnColor);
}
...
void handleTouch(int tx, int ty) {
    ...
    if (ty >= BUTTON_Y) {
        ...
        if (tx >= 15 && tx < 85) {
            // FEED
            drawButton(15, BUTTON_Y, BUTTON_W, BUTTON_H, "FEED", btnColor, true);
            delay(50);
            drawButton(15, BUTTON_Y, BUTTON_W, BUTTON_H, "FEED", btnColor, false);
            ...
            drawButton(85, BUTTON_Y, BUTTON_W, BUTTON_H, "ATTACK", btnColor, true);
            delay(50);
            drawButton(85, BUTTON_Y, BUTTON_W, BUTTON_H, "ATTACK", btnColor, false);
            ...
            // MENU
            drawButton(155, BUTTON_Y, BUTTON_W, BUTTON_H, "MENU", btnColor, true);
            delay(50);
            drawButton(155, BUTTON_Y, BUTTON_W, BUTTON_H, "MENU", btnColor, false);
