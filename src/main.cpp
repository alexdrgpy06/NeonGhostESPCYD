...
void drawMainButton(int x, const char* label, bool pressed = false) {
    ...
    int xOffset = 20;
    if (strcmp(label, "ATTACK") == 0) xOffset = 13;
    if (strcmp(label, "MENU") == 0) xOffset = 18;
    
    tft.setCursor(x + xOffset, BUTTON_Y + 18);
    tft.print(label);
}

void drawButtons() {
    drawMainButton(15, "FEED");
    drawMainButton(85, "ATTACK");
    drawMainButton(155, "MENU");
}
