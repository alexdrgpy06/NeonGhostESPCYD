...
void drawSingleButton(int x, const char* label, uint16_t btnColor, bool pressed) {
    if (pressed) {
        tft.fillRoundRect(x, BUTTON_Y, BUTTON_W, BUTTON_H, 6, btnColor);
        tft.drawRoundRect(x, BUTTON_Y, BUTTON_W, BUTTON_H, 6, C_WHITE);
        tft.setTextColor(C_DARK, btnColor);
    } else {
        tft.fillRoundRect(x, BUTTON_Y, BUTTON_W, BUTTON_H, 6, C_DARK);
        tft.drawRoundRect(x, BUTTON_Y, BUTTON_W, BUTTON_H, 6, btnColor);
