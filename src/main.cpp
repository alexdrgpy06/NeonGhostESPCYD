...
void drawGhostArea();
void fullReset();
void drawSingleButton(int x, const char* label, bool pressed);
...
void drawSingleButton(int x, const char* label, bool pressed) {
    ...
    // Center text horizontally based on string length (assume text size 1 -> 6px per char)
...
void drawButtons() {
    ...
    drawSingleButton(x1, "FEED", false);
    drawSingleButton(x2, "ATTACK", false);
    drawSingleButton(x3, "MENU", false);
}
...
void handleTouch(int tx, int ty) {
    ...
    if (ty >= BUTTON_Y) {
        if (tx >= 15 && tx < 85) {
            // FEED
            drawSingleButton(15, "FEED", true);
            delay(50);
            drawSingleButton(15, "FEED", false);
            ...
            drawSingleButton(85, "ATTACK", true);
            delay(50);
            drawSingleButton(85, "ATTACK", false);
            ...
            // MENU
            drawSingleButton(155, "MENU", true);
            delay(50);
            drawSingleButton(155, "MENU", false);
