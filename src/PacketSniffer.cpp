...
void PacketSniffer::processPacket(uint8_t *packet, uint16_t len) {
    ...
    // DATA FRAMES (Type 2) - EAPOL Detection
        ...
        // Fast path: skip encrypted frames. Encrypted 802.11 data frames cannot contain valid
        // plaintext EAPOL headers, so skipping payload inspection yields significant performance improvements.
