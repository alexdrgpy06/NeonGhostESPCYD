...
void PacketSniffer::processPacket(uint8_t *packet, uint16_t len) {
    ...
    // DATA FRAMES (Type 2) - EAPOL Detection
        ...
        // Skip encrypted frames (Protected bit set) and ensure minimum length.
        // EAPOL headers are unencrypted; checking the payload of an encrypted frame
        // is unnecessary and severely wastes CPU cycles.
