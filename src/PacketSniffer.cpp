...
void PacketSniffer::processPacket(uint8_t *packet, uint16_t len) {
    ...
    // DATA FRAMES (Type 2) - EAPOL Detection
        ...
        // Optimization: Only scan unencrypted frames for EAPOL (Type 0x888E)
        // Check Protected bit (Bit 14 of Frame Control, which is Bit 6 of Byte 1)
        bool isEncrypted = (packet[1] & 0x40) != 0;
