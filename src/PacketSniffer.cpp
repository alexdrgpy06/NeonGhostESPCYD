...
void PacketSniffer::processPacket(uint8_t *packet, uint16_t len) {
    ...
    // DATA FRAMES (Type 2) - EAPOL Detection
        ...
        // ⚡ Bolt Optimization: Skip payload inspection for encrypted data frames
        // Encrypted frames (Protected bit 0x40 set) cannot contain valid plaintext EAPOL headers.
        // This bounds check and early exit yields significant performance improvements.
