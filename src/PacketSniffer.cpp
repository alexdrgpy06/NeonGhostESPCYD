...
void PacketSniffer::processPacket(uint8_t *packet, uint16_t len) {
    ...
    // DATA FRAMES (Type 2) - EAPOL Detection
        ...
        // ⚡ BOLT OPTIMIZATION:
        // Skip encrypted frames (Protected bit 0x40 in Frame Control byte 2).
        // Encrypted frames cannot contain plaintext EAPOL headers, so scanning them is wasted CPU cycles.
